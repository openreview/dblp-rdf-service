...
class PublicationTypeHandlers:
    ...
    def isA_Publication(self, entity: Node, prop_val: Node):
        ...
        return EmitRepr(entity, Publication(pub_type=key))
...
class AuthorPropertyHandlers(SignaturePropertyHandlers, PublicationTypeHandlers):
    pass
...
###           Set entity b2.entry = PersonName("author")
###         """
###         return PersonName(name_type="author")
###
###     def isA_EditorSignature(self, entity: Node, prop_val: Node):
###         """The information that links a publication to an editor."""
